...
{
    public const int MEMORY_LIMIT = 256; // 256MB Limit
    public const int POOL_SIZE = 2; // 2 workers
    public const int COLLECT_INTERVAL = 1; // 1 tick
    public const int|float GARBAGE_COLLECT_INTERVAL = 15 * 60 * 20; // 15 minutes
